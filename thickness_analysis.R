...
habitat <- read_xlsx("morph_habitat_data.xlsx", sheet = "thick")
...
## calculate total width and natural log transform
...
## Multiple regression thickness~width
